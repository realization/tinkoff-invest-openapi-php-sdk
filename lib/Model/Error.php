...
class Error implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'tracking_id' => 'string',
'status' => 'string',
'payload' => '\Swagger\Client\Model\ErrorPayload'    ];
...
'payload' => 'getPayload'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = isset($data['status']) ? $data['status'] : 'Error';
     ...
     * Gets payload
     *
     * @return \Swagger\Client\Model\ErrorPayload
     */
     ...
     * Sets payload
     *
     * @param \Swagger\Client\Model\ErrorPayload $payload payload
     *
     * @return $this
     */
